...
namespace Assignment2_WDT.Migrations
{
    ...
    [Migration("20210128174622_NewMigration1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.Account", b =>
                {
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.BillPay", b =>
                {
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.Customer", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.Login", b =>
                {
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.Payee", b =>
                {
                    b.Property<int>("PayeeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.Transaction", b =>
                {
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.Account", b =>
                {
                    b.HasOne("Assignment2_WDT.Models.Customer", "Customer")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Assignment2_WDT.Models.BillPay", b =>
                {
                    b.HasOne("Assignment2_WDT.Models.Account", "Account")
                        .WithMany("BillPays")
                        .HasForeignKey("AccountNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Assignment2_WDT.Models.Payee", "Payee")
                        .WithMany("BillPays")
